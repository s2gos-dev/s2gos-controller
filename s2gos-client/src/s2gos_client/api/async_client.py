...
#   timestamp: 2025-10-08T14:28:16.820665
...
class AsyncClient(AsyncClientMixin):
    ...
    async def get_conformance(self, **kwargs: Any) -> ConformanceDeclaration:
        ...
        For more information, see [Section 7.4](https://docs.ogc.org/is/18-
        062r2/18-062r2.html#sc_conformance_classes).
    ...
    async def get_process(self, process_id: str, **kwargs: Any) -> ProcessDescription:
        ...
        062r2/18-062r2.html#sc_process_description).
    ...
    async def get_job(self, job_id: str, **kwargs: Any) -> JobInfo:
        ...
        062r2/18-062r2.html#sc_retrieve_status_info).
    ...
    async def get_job_results(self, job_id: str, **kwargs: Any) -> JobResults:
        ...
        062r2/18-062r2.html#sc_retrieve_job_results).
